...
The libraries loaded for import of Salmon data into a dataset accepted by DESeq2 are `readr`, `tximport`, `tximportData` and `GenomicFeatures`.
...
Paths for the file containing sample information, annotation information and the count data have to be set. Additionaly the output directorie is created.
